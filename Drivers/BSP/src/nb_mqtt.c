...
NB_TaskStatus nb_MQTT_uri_run(const char* param)
{
	...
	else if(strstr((char*)nb.usart.data,QMTOPEN": 0,-1") != NULL)
	{
		NBTask[_AT_MQTT_URI].nb_cmd_status = NB_OPEN_FAIL;	
	}
